...
- New Wearly features should use the target stack: Node.js 24, TypeScript, PostgreSQL, Drizzle, Vitest, and AWS CDK.
...
- Domain code must remain independent of Drizzle, AWS, HTTP, environment variables, and framework decorators.
