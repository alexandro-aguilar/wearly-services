...
import { DeactivateProductHandler } from '../../application/commands/DeactivateProductHandler';
import Joi from '@hapi/joi';
import Authorization from '@src/app/core/interface/Authorization';

const deactivateProductEndpointHandlerSchema: ValidatorSchemas = {
...
export const handler = middy(
  ...
  .use(requestValidator(deactivateProductEndpointHandlerSchema))
