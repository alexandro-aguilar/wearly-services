...
const types = {
  ...
  SalesProductRepository: Symbol.for('SalesProductRepository'),
  ...
  CheckoutQuoteRepository: Symbol.for('CheckoutQuoteRepository'),
  CheckoutPricingService: Symbol.for('CheckoutPricingService'),
  CheckoutCatalogGateway: Symbol.for('CheckoutCatalogGateway'),
  CheckoutPromotionGateway: Symbol.for('CheckoutPromotionGateway'),
