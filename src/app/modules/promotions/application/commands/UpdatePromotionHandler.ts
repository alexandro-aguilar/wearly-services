...
import { Promotion, UpdatePromotionInput } from '@src/app/modules/promotions/domain/Promotion';
...
export class UpdatePromotionHandler {
  ...
  async execute(principal: AuthenticatedPrincipal, id: string, command: UpdatePromotionInput): Promise<void> {
