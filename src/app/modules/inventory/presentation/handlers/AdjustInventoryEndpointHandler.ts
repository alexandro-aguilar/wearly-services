...
import { AdjustInventoryHandler } from '../../application/commands/AdjustInventoryHandler';

const adjustInventoryEndpointHandlerSchema: ValidatorSchemas = {
  body: Joi.object({
...
export const handler = middy(
  ...
  .use(requestValidator(adjustInventoryEndpointHandlerSchema))
