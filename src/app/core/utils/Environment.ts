export default class Environment {
  ...
  static readonly POWERTOOLS_SERVICE_NAME = process.env.POWERTOOLS_SERVICE_NAME || 'wearly-services';
  static readonly POWERTOOLS_LOG_LEVEL = process.env.POWERTOOLS_LOG_LEVEL || 'INFO';
  static readonly PROJECT_NAME = process.env.PROJECT_NAME || 'Wearly Services';

  static readonly DB_HOST = process.env.DB_HOST || 'postgres_wearly_services_db';
  ...
  static readonly DB_NAME = process.env.DB_NAME || 'wearly_services';
